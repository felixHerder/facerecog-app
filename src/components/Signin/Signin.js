        ...
        <div className="measure">
          <fieldset id="sign_up" className="ba b--transparent ph0 mh0">
            ...
            <div className="mt3">
              ...
              <input className="pa2 input-reset ba bg-transparent hover-bg-black-50 hover-white mw5 w-100" type="email" name="email-address" id="email-address" onChange={this.onEmailChange} />
            </div>
            <div className="mv3">
              <label className="db fw6 lh-copy f6" htmlFor="password">Password</label>
              <input className="b pa2 input-reset ba bg-transparent hover-bg-black-50 hover-white mw5 w-100" type="password" name="password" id="password" onChange={this.onPasswordChange} />
            </div>
          </fieldset>
          <div>
